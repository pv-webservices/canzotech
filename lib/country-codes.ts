// International dialling codes for the enquiry form's phone field, keyed by ISO 3166-1 alpha-2.
// The ISO code is the stored value because some dialling codes are shared (e.g. +1 for the US and Canada).
...
export function findCountry(iso: string): CountryCode {
  return countryCodes.find((country) => country.iso === iso) ?? countryCodes.find((country) => country.iso === DEFAULT_COUNTRY_ISO)!;
}
